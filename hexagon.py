...
MODE_HEXAGON = 4  # New mode for hexagon

MODE = MODE_HEXAGON  # Change mode to hexagon
ITERATIONS = 1024
LEAF_SIZE = 4
PADDING = 1
FILL_COLOR = (0, 0, 0)
...
def main():
    input_folder = 'img'
    output_image_folder = 'output_images_hexagon1'
    output_gif_folder = 'output_gif_hexagon'
