...
MODE_RECTANGLE = 1
MODE_ELLIPSE = 2
MODE_ROUNDED_RECTANGLE = 3  # Define a new mode for rounded rectangles

MODE = MODE_ROUNDED_RECTANGLE  # Set the default mode to rounded rectangle
ITERATIONS = 1024
LEAF_SIZE = 4
PADDING = 1
FILL_COLOR = (0, 0, 0)
    ...
    def render(self, path, max_depth=None):
        ...
        for quad in self.root.get_leaf_nodes(max_depth):
            ...
            if MODE == MODE_ELLIPSE:
                ...
                # Use rounded_rectangle function
...
def main():
    input_folder = 'img'
    output_image_folder = 'output_images_rounded_rectangle'
    output_gif_folder = 'output_gif_rounded_rectangle'
